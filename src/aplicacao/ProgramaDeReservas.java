...
public class ProgramaDeReservas {
	...
	public static void main(String[] args) throws ParseException {
		...
		//Testando se as datas fornecidas são FUTURAS, ou seja, POSTERIORES a 'hoje'.
		
		Date hoje = new Date(); //Atribuir à variável 'hoje' a data de hoje!
		if (dataEntrada.before(hoje) || dataSaida.before(hoje)) {
			System.out.println("Erro na reserva: a(s) data(s) informada(s) é(são) anterior(es) ao dia de hoje!");
		}
